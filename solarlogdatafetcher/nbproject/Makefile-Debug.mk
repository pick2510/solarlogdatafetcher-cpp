...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/solarlogdatafetcher: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/solarlogdatafetcher ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/Inverter.o: src/Inverter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Inverter.o src/Inverter.cpp

${OBJECTDIR}/src/Modulestring.o: src/Modulestring.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Modulestring.o src/Modulestring.cpp

${OBJECTDIR}/src/Plant.o: src/Plant.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Plant.o src/Plant.cpp

${OBJECTDIR}/src/md5.o: src/md5.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/md5.o src/md5.cpp

${OBJECTDIR}/src/solarlogdatafetcher.o: src/solarlogdatafetcher.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/solarlogdatafetcher.o src/solarlogdatafetcher.cpp
